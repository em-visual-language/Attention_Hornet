...
class CUHK03(object):
    ...
    ###def __init__(self, root='/data_1/zhaojianan/Project/Video_ReID/data/image_ReID', verbose=True, **kwargs):
    def __init__(self, root='/data_1/zhaojianan/Project/Video_ReID/data/image_ReID', split_id=0, cuhk03_labeled=False, cuhk03_classic_split=False, verbose=True, **kwargs):
