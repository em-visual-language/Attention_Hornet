...
root_path = '/data_1/zhaojianan/Project/visual_language/data/CUHK-PEDES/'
...
def read_sentence(img_path):
    ...
    ###print(key_image)
    path = '/data_1/zhaojianan/Project/visual_language/data/CUHK-PEDES/CUHK-PEDES/imgs/' + key_image
    caption_raw = ''
    ###print(path)
    ...
    worddict_tmp = pickle.load(open('/data_1/zhaojianan/Project/visual_language/Hornet/person_reid_language_v1/data/wordlist_reid.p', 'rb'))
