...
parser.add_argument('--vis-ranked-res', action='store_true', help="visualize ranked results, only available in evaluation mode (default: False)")
# Others
...
# TODO: Train
if True:
    args = parser.parse_args([ #'--root', '/data_1/zhaojianan/Project/visual_language/Hornet/person_reid_language_v1/',
                              '--root', '/data_1/zhaojianan/Project/Video_ReID/data/image_ReID',
                              '--dataset','market1501',#'market1501',#'cuhk03',
                              '--cuhk03-labeled',
                              '--cuhk03-classic-split',
                              #=================
                              '--save-dir', '/data_1/zhaojianan/Project/visual_language/Hornet/person_reid_language_v3/log',
                              #=================
                              '--arch','resnet50',
                              #=================
                              '--gpu-devices','0',
...
if False:
    args = parser.parse_args(['--evaluate',
                              '--root', '/data_1/zhaojianan/Project/visual_language/Hornet/person_reid_language_v1/',
                              '--dataset', 'cuhk03',
                              '--cuhk03-labeled',
                              '--cuhk03-classic-split'
...
def main():
    ...
    scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325, 350, 375, 400,425, 450], gamma=0.3)
